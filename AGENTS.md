...
Before implementing, changing, or reviewing any feature work in this repository, agents MUST consult the local `openclaw` repository in `../openclaw` for relevant feature behavior, flows, and reference details.

## Frontend Architecture Mandate

For frontend and UI work, agents MUST follow the project architecture defined in [docs/FRONTEND_SPEC.md](docs/FRONTEND_SPEC.md).
